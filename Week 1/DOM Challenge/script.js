...
function tampil(keyword = null) {
   ...
   for (let i = 0; i < items.length; i++) {
      ...
      render += `<div class="card col-md-4 mt-2" style="width: 18rem;">
                  <img src="images/${items[i][4]}" class="card-img-top" alt="${items[i][4]}">
                  <div class="card-body">
...
// items.forEach((el, id) => {
//    render +=   `<div class="card" style="width: 18rem;">
//                   <img src="images/${el[4]}" class="card-img-top" alt="${el[4]}">
//                   <div class="card-body">
//                   <h5 class="card-title">${el[1]}</h5>
//                   <p class="card-text">${el[3]}</p>
//                   <p class="card-text">${el[2]}</p>
